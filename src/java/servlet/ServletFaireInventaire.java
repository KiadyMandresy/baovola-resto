...
import table.Inventaire;

/**
 *
 * @author Dawood
 */
public class ServletFaireInventaire extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("idingredient")!=null && request.getParameter("qte")!=null){
                ...
                String message ="";
                try{
                    inv.insertInventaire(idingr, qte);
                    message = "Inventaire fait";
                }catch(Exception ex){
                    message = "Inventaire echoué";
                }
                request.setAttribute("message", message);
            }
            
            String view = "faireinventaire.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletFaireInventaire.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
