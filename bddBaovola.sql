...
CREATE view listePlatCommande as select p.designation,c.datecom as date,d.id,d.qte as quantite from detailCommande as d 
JOIN commande as c ON (d.idCommande=c.id) 
